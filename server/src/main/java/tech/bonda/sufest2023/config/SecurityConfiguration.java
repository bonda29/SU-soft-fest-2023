package tech.bonda.sufest2023.config;
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> {
                    ...
                    auth.requestMatchers("/clientVersion/**").hasAnyRole("USER", "COMPANY");
                    auth.requestMatchers("/businessVersion/**").hasAnyRole("USER", "COMPANY");
                    auth.requestMatchers("/payment/**").hasAnyRole("USER", "COMPANY");
